...
class Test_scoatem_ingredient(unittest.TestCase):
    ...
    SCOATEM_SALAM_DULCE = (By.XPATH, '/html/body/div[2]/main/section/div/article/form/div/div[2]/div[2]/div[3]/div/ul/li')
    ...
    def test_scoatem_ingredient(self):
        ...
        self.chrome.find_element(*self.SCOATEM_SALAM_DULCE).click()
        expected_message = "Fără Salam dulce"
        actual_message = self.chrome.find_element(*self.MESAJ_INGREDIENT_SCOS).text
        self.assertEqual(expected_message, actual_message, "The ingredient removal message did not match the expected.")
